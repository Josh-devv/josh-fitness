...
const popu = async()=> {
  const api = await fetch (
    `https://api.spoonacular.com/recipes/complexSearch?apiKey=09246148fe3640fea60367c198852f8b`
  )
  ...
  return (
    <div className="w-[100%] font-dmsans text-[white]">
        ...
        <div className="absolute flex justify-center w-[100%] max-sm:top-[40%] top-[50%]">
            <div className="w-[90%]">
                <h1 className="text-[75px] max-xxsm:text-[35px] font-bold max-sm:text-[45px]">Healthy foods</h1>
                <p className="text-[20px] max-xxsm:text-[12px] max-sm:text-[15px] max-md:w-[70%] max-sm:w-[95%] w-[50%]">
        ...
        <div className="text-[25px] w-[85%] flex justify-center flex-col font-medium max-sm:text-[15px]">
                ...
                <p className="font-normal w-[70%] max-xxsm:w-[100%] max-xxsm:text-[10px] max-sm:text-[12px] max-lg:w-[90%] max-sm:w-[97%] pb-2 text-[15px]">
