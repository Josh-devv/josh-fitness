...
const RecipeDetails = () => {
    ...
    const popu = async()=> {
        const api = await fetch (
          `https://api.spoonacular.com/recipes/${id}/information?apiKey=09246148fe3640fea60367c198852f8b`
        )
  ...
  return (
    <div className="font-dmsans">
        <Navbar top={top}/>
        {
            ...
            <div className="absolute top-0 left-0 w-full h-[100%] bg-black z-20 opacity-60"></div>
            <img src={ii} className="absolute h-[100%] bg-cover object-cover w-[100%]"/>
            <div className="absolute  w-[100%] justify-center flex top-[40%] h-[100%]">
                <div className="w-[90%] z-30">
                    <h1 className="text-white max-sm:text-[40px] max-lg:text-[50px] max-xxsm:text-[30px] font-bold  text-[70px]">{detail.title}</h1>
        ...
        <div className="w-[90%] flex flex-col justify-between">
            ...
            <div className="w-[100%] max-md:flex-col flex justify-between">
                <div className="w-[70%] max-md:py-2 max-md:w-[100%] max-lg:w-[60%]">
                    ...
                    <p className="w-[90%] max-xxsm:text-[12px] text-[15px] py-5">A fun twist on a classic! All the flavours you know and love from a falafel in the form of waffle, perfectly crispy with no deep-frying involved. Served with cucumber tomato salad cilantro yogurt sauce for a light and refreshing brunch dish.</p>
