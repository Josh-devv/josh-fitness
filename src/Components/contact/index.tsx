  ...
  return (
    <section id="" className="w-[100%] pt-20 max-sm:pt-10 py-8 flex flex-col justify-center items-center font-dmsans text-white  bg-black ">
        <div className="text-[25px] w-[90%] flex justify-center flex-col font-medium max-sm:text-[15px]">
            ...
            <p className="font-normal w-[70%] pb-5 text-[15px]">
        ...
        <div className="w-[100%]">
          <form>
            <div className="mb-4">
              ...
              <input type="text" id="name" name="name" placeholder="Enter your name" className="border-gray-300 max-md:w-[100%] max-lg:w-[350px] w-[500px] bg-black border p-6 rounded-full" />
            </div>

            <div className="mb-4">
              <input type="email" id="email" name="email" placeholder="xyz@gmail.com" className="border-gray-300 max-md:w-[100%]  max-lg:w-[350px] w-[500px] bg-black border p-6 rounded-full" />
            </div>

            <div className="mb-4">
              
              <textarea id="message" name="message" placeholder="Enter your message"  className="border-gray-300 max-md:w-[100%]  max-lg:w-[350px] w-[500px] bg-black border p-6 rounded-3xl"></textarea>
            </div>
