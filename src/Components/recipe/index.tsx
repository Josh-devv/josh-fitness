        ...
        >
            ...
            <div className="flex pt-10 max-md:flex-col  justify-between">
                <div className="flex w-[70%] max-sm:flex-col max-md:w-[100%] items-center">
                    ...
                    >
                        <img src={rec1}  className="rounded-3xl h-[450px] max-xxsm:h-[300px] max-xxsm:w-[100%] max-sm:h-[300px] max-sm:bg-cover max-sm:w-[100%]  max-lg:w-[280px]"/> 
                    </motion.div>
                ...
                <div className="w-[30%] max-md:w-[100%] max-md:pt-10 max-sm:pt-5">
                    <motion.div 
                    className="flex max-sm:hidden flex-col max-sm:grid-cols-2 max-md:flex-row justify-around max-md:justify-between h-full"
                    initial="hidden"whileInView
                    ="visible"
                    viewport={{ once: true, amount: 0.5 }}
                    transition={{ duration: 0.2 }}
